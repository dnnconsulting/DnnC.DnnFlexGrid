...
<!-- Start : content panes (boxed) -->
<div class="flex-container">

    <div class="frame">
        <div id="row3_1" runat="server" class="box-2"/>
        <div id="row3_2" runat="server" class="box-2"/>
        <div id="row3_3" runat="server" class="box-2"/>
    </div>

    <div class="frame">
        <div id="top" runat="server" class="box"/>
    </div>
    
    <div class="frame">
        <div id="row1_1" runat="server" class="box"/>
        <div id="row1_2" runat="server" class="box" />
    </div>

    <div class="frame">
        <div id="row2_1" runat="server" class="box"/>
        <div id="row2_2" runat="server" class="box-3"/>
    </div>
    
</div><!-- end ./content panes (boxed) -->
